...
import com.example.a.myviewtest.adapter.MyAdapter;
...
public class RecycleViewActivity extends AppCompatActivity {
    ...
    private void setadapter() {
        myAdapter = new MyAdapter(RecycleViewActivity.this, urls);
    ...
    private void loadMore(final MyAdapter myAdapter) {
    ...
    private void refresh(final MyAdapter myAdapter) {
        Runnable runnable = new Runnable() {
            @Override
            public void run() {
                urls.clear();
